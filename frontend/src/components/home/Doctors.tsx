  ...
  return (
    <section id="doctors" className="py-24 bg-[#F8FAFC] font-cairo">
      <div className="container mx-auto px-4">
        ...
        {/* 1. دخلنا الهيدر جوه الكونتينر + عطيناه center={false} */}
        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
          <SectionHeader 
            subtitle="نخبة الخبراء" 
            title="تعرف على أفضل الاطباء" 
            center={false} // عشان يروح يمين في الديسك توب
          />
          
          {/* زر عرض كل الأطباء خليناه يتحاذى مع العنوان في الـ Desktop */}
          <Link 
            to="/doctors" 
            className="mb-8 bg-white text-primary border-2 border-primary/10 px-8 py-3 rounded-full font-bold hover:bg-secondary hover:text-white transition-all duration-300 flex items-center gap-2 shadow-sm"
          >
